...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == ADD_NOTE_RQUEST_CODE && resultCode == RESULT_OK) {
            String title = data.getStringExtra(AddNoteActivity.KEY_EXTRA_TITLE);
            String desrciption = data.getStringExtra(AddNoteActivity.KEY_EXTRA_DESCRIPTION);
            int periorty = data.getIntExtra(AddNoteActivity.KEY_EXTRA_PERIORTY, 1);
